...
class DogCardAdapter(
    ...
    class DogCardViewHolder(private val view: View?): RecyclerView.ViewHolder(view!!) {
        ...
        val textNameView: TextView? = view?.findViewById(R.id.dog_name)
        val textAgeView: TextView? = view?.findViewById(R.id.dog_age)
        val textHobbyView: TextView? = view?.findViewById(R.id.dog_hobby)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DogCardViewHolder {
        ...
        return if(layout == 1 || layout == 2){
            DogCardViewHolder(LayoutInflater.from(parent.context)
    ...
    override fun onBindViewHolder(holder: DogCardViewHolder, position: Int) {
        ...
        holder.textHobbyView?.text = resources?.getString(R.string.dog_hobbies, item.hobbies)
    }
}
